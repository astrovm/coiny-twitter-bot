...
module.exports = {
  ...
  */
  head: {
    title: 'Coiny',
    meta: [{ charset: 'utf-8' }, { name: 'viewport', content: 'width=device-width, initial-scale=1' }, { hid: 'description', name: 'description', content: 'Bitcoin fee estimates and market info.' }, { name: 'apple-mobile-web-app-title', content: 'Coiny' }, { name: 'application-name', content: 'Coiny' }, { name: 'msapplication-TileColor', content: '#2d3436' }, { name: 'theme-color', content: '#2d3436' }],
