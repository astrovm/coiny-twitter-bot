...
module.exports = {
  ...
  */
  head: {
    title: 'Coiny',
    meta: [{ charset: 'utf-8' }, { name: 'viewport', content: 'width=device-width, initial-scale=1' }, { hid: 'description', name: 'description', content: 'Nuxt.js project' }, { name: 'apple-mobile-web-app-title', content: 'Coiny' }, { name: 'application-name', content: 'Coiny' }, { name: 'msapplication-TileColor', content: '#2d3436' }, { name: 'theme-color', content: '#2d3436' }],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Users_astrolince_dev_coiny_node_modules_babel_runtime_regenerator__ = __webpack_require__(1);
...
var start = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__Users_astrolince_dev_coiny_node_modules_babel_runtime_regenerator___default.a.mark(function _callee2() {
    var _this = this;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            ...
            app.use(function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__Users_astrolince_dev_coiny_node_modules_babel_runtime_regenerator___default.a.mark(function _callee(ctx, next) {
